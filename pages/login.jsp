<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@ page import="com.coffee.entity.message" %>   
   <!DOCTYPE html>
<html lang="eng">
    <head>
         <meta charset="UTF-8">
    ...
    <body class="b">
              ...
              //   message m2=(message)session.getAttribute("msg1");
                 if(m!=null)
                 {            	 
                 %>
        ...
        <div class="f container">
            ...
            <div class="frmlg">
                ...
                <form action="../LoginUser" method="POST">
                  ...
                  <input type="text" name="name" class="ifrm1 form-control" id="input4"
                ...
                <div class="b2 col-md-6 col-lg-12 col-12">
                  <button type="submit" class="bttn3 text-white">Login</button>
                </div>                                      
                </form>
            </div>
        </div>
